...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background font-sans text-text-main flex flex-col">
      ...
      <nav className={`fixed bottom-0 left-0 right-0 bg-surface flex items-center justify-around z-50 h-16 px-2 pb-2 shadow-[0_-1px_3px_0_rgba(0,0,0,0.05)] transition-transform duration-300 ${isNavVisible ? 'translate-y-0' : 'translate-y-full'}`}>
